			...
			<div class="product__description-container">
				...
				<ul class="product__characteristics-list">
					<li class="product__characteristics-item">
						...
						<br> Данные отличия дают преимущества в процессе монтажа и эксплуатации небольших отопительных систем, т.к. в первую очередь экономится место – для размещения отопительной системы подобного типа не требуется отдельное помещение, уменьшаются затраты
    ...
    <div class="product__container">
        ...
        <div class="container_flex-row">
            ...
            <div class="product__table-container">
                ...
                <style id="Zota Smart_13871_Styles">
                    table {
